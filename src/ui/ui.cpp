        ...
        if (ImGui::BeginTabBar("MainTabBar", ImGuiTabBarFlags_Reorderable)) {
            for (const auto &tab: TABS) {
                const ImGuiTabItemFlags flags
                    = (g_activeTab == tab.tabId) ? ImGuiTabItemFlags_SetSelected : ImGuiTabItemFlags_None;
...
bool RenderUI() {
    ...
    constexpr ImGuiWindowFlags mainFlags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse
